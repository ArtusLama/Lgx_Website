...
<template>
    ...
    <NuxtLayout>
        <div class="bg-[url('/imgs/HeroBackground.png')] opacity-20 pointer-events-none inset-0 absolute bg-cover bg-center -z-10" />

        <div class="mt-[15vh] text-center flex flex-col items-center">
